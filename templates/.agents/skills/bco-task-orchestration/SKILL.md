...
5. Record exact path and exclusive-resource owners; transfer focused runtime reproduction to the coder only within task authority, then to independent tester acceptance after settlement. Refuse stale/missing tree, predecessor or resource evidence. Follow `ai-docs/commands.md` for ports and cleanup.
